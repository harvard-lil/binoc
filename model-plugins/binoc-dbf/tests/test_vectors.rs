//! Plugin test vectors: binoc-dbf/test-vectors/. Uses the shared harness from
//! binoc_stdlib::test_vectors; the DbfMaterializer that builds `.dbf` from
//! `.dbf.d` lives in `binoc_dbf::test_support`.
//!
