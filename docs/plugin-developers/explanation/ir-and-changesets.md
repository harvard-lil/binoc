...
[changeset JSON schema](../../users/reference/changeset-schema.md) is the canonical
contract.
...
- For the JSON contract → [changeset schema reference](../../users/reference/changeset-schema.md).
