...
| **IR** | *Intermediate representation.* The tree of `DiffNode` values produced by comparators and rewritten by transformers. Every changeset is a serialized IR tree. See [IR and changesets](../../plugin-developers/explanation/ir-and-changesets.md). |
