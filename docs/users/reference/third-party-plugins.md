...
Binoc ships a capable [standard library](../../plugin-developers/explanation/plugin-model.md) (`binoc-stdlib`), but some datasets use formats that need a dedicated comparator. Install one of the **add-on plugins** below when your snapshots include those kinds of files.
