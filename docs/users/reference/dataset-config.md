...
[Dispatch model](../../plugin-developers/explanation/dispatch-model.md) for the full
story.
...
See [Artifacts and composition](../../plugin-developers/explanation/artifacts-and-composition.md)
