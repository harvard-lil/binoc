...
!!! note "Research note — a presentation, not a spec"
    ...
    [ADR index](../../adr/README.md); for the maintained prose see the
    [architecture overview](../../plugin-developers/explanation/architecture.md)
    and the rest of the explanation set. Sources: the codebase and the ADR
    decision record, as of June 2026.
